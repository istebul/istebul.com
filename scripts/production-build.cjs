...
const staticFiles = ['_headers', '_redirects', '_routes.json', 'index.html', 'offline.html', 'manifest.json', 'sw.js', 'robots.txt', 'sitemap.xml', 'ads.txt', 'admin-panel.html', 'importmap.json', 'favicon.ico', 'warehouse/index.html', 'warehouse/offline.html', 'warehouse/manifest.webmanifest', 'warehouse/sw.js', 'css/warehouse/operations-center.css', 'css/warehouse/barcode-scanner.css', 'css/warehouse/receiving-mobile.css', 'css/warehouse/putaway-mobile.css', 'css/warehouse/picking-mobile.css', 'css/warehouse/packing-mobile.css', 'css/warehouse/cycle-count-mobile.css', 'js/warehouse/pwa.js', 'js/warehouse/mobile-navigation.js', 'js/warehouse/barcode-scanner.js', 'js/warehouse/operations-center.js', 'js/warehouse/locations-ui.js', 'js/warehouse/receiving-ui.js', 'js/warehouse/receiving-write-controller.js', 'js/warehouse/receiving-client.js', 'js/warehouse/receiving-lookup.js', 'js/warehouse/putaway-lookup.js', 'js/warehouse/putaway-client.js', 'js/warehouse/putaway-ui.js', 'js/warehouse/putaway-write-controller.js', 'js/warehouse/picking-lookup.js', 'js/warehouse/picking-client.js', 'js/warehouse/picking-ui.js', 'js/warehouse/picking-write-controller.js', 'js/warehouse/packing-lookup.js', 'js/warehouse/packing-client.js', 'js/warehouse/shipping-client.js', 'js/warehouse/shipping-lookup.js', 'js/warehouse/shipping-ui.js', 'js/warehouse/shipping-write-controller.js', 'js/warehouse/packing-ui.js', 'js/warehouse/packing-write-controller.js', 'js/warehouse/cycle-count-ui.js', 'js/warehouse/cycle-count-client.js', 'js/warehouse/cycle-count-quantity-ui.js', 'js/warehouse/cycle-count-write-controller.js', 'js/warehouse/cycle-count-evaluation-client.js', 'js/warehouse/cycle-count-evaluation-controller.js', 'js/warehouse/cycle-count-recount-evaluation-client.js', 'js/warehouse/cycle-count-recount-evaluation-controller.js', 'js/warehouse/cycle-count-recount-client.js', 'js/warehouse/cycle-count-recount-ui.js', 'js/warehouse/cycle-count-recount-controller.js', 'js/warehouse/cycle-count-completion-client.js', 'js/warehouse/cycle-count-report-ui.js', 'js/warehouse/cycle-count-review-ui.js', 'js/core/config.js', 'js/core/supabase.js', 'js/core/ai-proxy-client.js', 'js/warehouse/supabase-browser.js', 'js/warehouse/operations-copilot-narration.js', 'auto/index.html', 'business/index.html',
