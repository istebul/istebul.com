...
const mustContain = [
  ...
  ['ai/index.html', 'ib-hero-v4'],
  ['ai/index.html', 'hero-v4-title'],
  ['ai/index.html', 'ib-hero-v4-trust'],
  ['ai/index.html', 'data-preview-title'],
  ['ai/index.html', 'Sigorta'],
  ['js/platform/category-registry.js', "displayName: 'Kasko'"],
  ['js/platform/category-registry.js', "displayName: 'Sigorta'"],
