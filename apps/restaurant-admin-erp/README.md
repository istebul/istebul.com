...
| `/garson/erp/checkin` | Check-in Engine (P7-H) |
| `/garson/erp/payments` | Reservation Guarantee & Payment Foundation (P7-I) |
...
- **P7-H:** Customer journey check-in (today list, walk-in, queue, table assign, no-show/late)
- **P7-I:** Payment dashboard KPIs, reservation guarantee policy settings, payment transactions drawer, settlement prep, payment provider strategy stubs (no live charge)
...
- Realtime channels: `erp-dashboard`, `erp-orders`, `erp-reservations`, `erp-tables`, `erp-checkin`, `erp-payments`, `erp-menu`, `erp-inventory`
