...
const RPC_PATH =
  "/rest/v1/rpc/warehouse_cycle_count_evaluate_first_count";
...
function safeRpcMessage(
  ...
  if (
    ...
    return "Sayım değerlendirmesi şu anda tamamlanamadı.";
  }
...
const INPUT_MESSAGES = {
  ...
  body_fields_invalid:
    "Sayım değerlendirme isteği desteklenmeyen üst seviye alan içeriyor.",

  action_invalid:
    "Bu Cycle Count değerlendirme işlemi desteklenmiyor.",
  ...
  payload_invalid:
    "Sayım değerlendirme payloadı geçerli bir JSON nesnesi olmalıdır.",

  payload_fields_invalid:
    "Sayım değerlendirme payloadı desteklenmeyen alan içeriyor.",
...
export async function onRequestPost(
  ...
  if (
    ...
    return errorResponse(
      500,
      "CONFIGURATION_ERROR",
      "WarehouseIQ sayım değerlendirme servisi yapılandırılamadı.",
      origin
    );
  }
  ...
  if (!token) {
    return errorResponse(
      401,
      "UNAUTHORIZED",
      "Sayım değerlendirmesi için oturum açmanız gerekir.",
      origin
    );
  }
  ...
  if (!normalized.ok) {
    return errorResponse(
      ...
      "Sayım değerlendirme isteği geçersiz.",
      origin
    );
  }
  ...
  try {
    ...
    return errorResponse(
      ...
      "Sayım değerlendirme servisine şu anda ulaşılamıyor.",
      origin
    );
  }
  ...
  if (!safeData) {
    return errorResponse(
      ...
      "Sayım değerlendirme servisi geçerli bir sonuç döndürmedi.",
      origin
    );
  }
