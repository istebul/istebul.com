...
export const LEGACY_TO_SITE_EVENT = Object.freeze({
  ...
  kasko_pdf_download: 'pdf_downloaded',
  decision_report_print_click: 'pdf_downloaded',
  finance_report_print_click: 'pdf_downloaded',
  travel_report_print_click: 'pdf_downloaded',
