...
export const PRICING_MESSAGING = Object.freeze({
  ...
  subhead:
    'Bu planlar İSTEBUL AI karar ürününe aittir (GarsonAI / İSTEBUL Business değil). Bakım, yakıt, kredi, sigorta ve değer kaybı birlikte düşünülmezse “ucuz araç” pahalıya çıkar. Ücretsiz temel analiz; Pro ile senaryo karşılaştırma ve gelişmiş AI açıklaması.',
