...
const tr = {
  ...
  stripeTitle: 'Stripe · PCI',
  stripeDesc: 'Ödeme Stripe üzerinden; kart bilgileri sunucularımızda saklanmaz.',
  cancelTitle: 'İptal',
  cancelDescHtml:
    'Aboneliği Stripe müşteri panelinden veya hesabınızdan istediğiniz zaman sonlandırın. <a href="/abonelik-iptal.html">İptal rehberi</a>',
  trialTitle: 'Deneme',
  trialDesc: 'İlk Pro aboneliğinde {days} gün ücretsiz; deneme bitiminde seçtiğiniz dönem ücretlendirilir — sürpriz yok.',
  ...
  freeCta: 'TCO analizini başlat',
  proName: 'isteBul Pro',
  proDesc: 'Detaylı TCO, senaryo karşılaştırma, gelişmiş AI açıklama ve premium rapor',
  proSecondaryCta: 'Önce ücretsiz TCO analizi',
  proPriceHint: 'Stripe ile güvenli ödeme · dilediğiniz zaman iptal',
  trialHint: ' · İlk abonelikte {days} gün ücretsiz',
  ...
  trustTrial: '{days} gün ücretsiz deneme (ilk abonelik)',
  trustStripe: 'Stripe ile güvenli ödeme',
  trustCancel: 'Panelden iptal — taahhütsüz',
...
const en = {
  ...
  stripeTitle: 'Stripe · PCI',
  stripeDesc: 'Payments via Stripe; card data is not stored on our servers.',
  cancelTitle: 'Cancel',
  cancelDescHtml:
    'End your subscription anytime from the Stripe customer portal or your account. <a href="/abonelik-iptal.html">Cancellation guide</a>',
  trialTitle: 'Trial',
  trialDesc:
    '{days}-day free trial on first Pro subscription; your chosen billing period applies after trial — no surprises.',
  ...
  proPriceHint: 'Secure Stripe checkout · cancel anytime',
  trialHint: ' · {days}-day free trial on first subscription',
  ...
  trustTrial: '{days}-day free trial (first subscription)',
  trustStripe: 'Secure Stripe checkout',
...
const de = {
  ...
  cancelDescHtml:
    'Abonnement jederzeit im Stripe-Kundenportal oder im Konto beenden. <a href="/abonelik-iptal.html">Kündigungsleitfaden</a>',
...
const ar = {
  ...
  stripeDesc: 'الدفع عبر Stripe؛ لا نخزّن بيانات البطاقة على خوادمنا.',
  cancelTitle: 'إلغاء',
  trialTitle: 'تجربة',
  ...
  trustStripe: 'دفع آمن عبر Stripe',
