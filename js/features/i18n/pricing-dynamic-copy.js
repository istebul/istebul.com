...
const en = {
  ...
  paymentDesc:
    'Payment infrastructure is prepared. Charges begin after provider activation; card data is not stored on our servers.',
  cancelTitle: 'Cancel',
  cancelDescHtml:
    'Pro cancellation via <a href="mailto:info@istebul.com?subject=Pro%20Subscription%20Cancellation">info@istebul.com</a> or <a href="/iletisim.html?konu=abonelik">support</a>. Email marketing opt-out: <a href="/abonelik-iptal.html">email preferences</a>.',
  trialTitle: 'Pro early access',
  trialDesc:
    'Pro features are in a pilot access phase. You will be notified after payment provider activation.',
  ...
  trustTrial: 'Pro pilot access',
  trustPayment: 'After payment activation',
  trustCancel: 'Cancel via support',
...
const de = {
  ...
  cancelDescHtml:
    'Pro-Kündigung über <a href="mailto:info@istebul.com?subject=Pro%20Abonnement%20K%C3%BCndigung">info@istebul.com</a> oder <a href="/iletisim.html?konu=abonelik">Support</a>. E-Mail-Marketing abbestellen: <a href="/abonelik-iptal.html">E-Mail-Einstellungen</a>.',
  paymentTitle: 'Zahlungsstatus',
  paymentDesc: 'Zahlungsinfrastruktur ist vorbereitet. Nach Aktivierung des Anbieters sind Zahlungen möglich; keine Kartenspeicherung bei uns.',
  trustPayment: 'Nach Zahlungsaktivierung',
  trialTitle: 'Pro-Frühzugang',
  trialDesc: 'Pro-Funktionen befinden sich in einer Pilotphase. Nach Aktivierung des Zahlungsanbieters erfolgt eine Benachrichtigung.',
  proPriceHint: 'Pilotzugang · Benachrichtigung nach Aktivierung',
  trustTrial: 'Pro-Pilotzugang',
  trustCancel: 'Kündigung über Support',
...
const ar = {
  ...
  paymentTitle: 'حالة الدفع',
  paymentDesc: 'البنية التحتية للدفع جاهزة؛ تبدأ المدفوعات بعد تفعيل المزود؛ لا نخزّن بيانات البطاقة على خوادمنا.',
  cancelTitle: 'إلغاء',
  cancelDescHtml:
    'إلغاء Pro عبر <a href="mailto:info@istebul.com?subject=Pro%20Subscription%20Cancellation">info@istebul.com</a> أو <a href="/iletisim.html?konu=abonelik">الدعم</a>. إلغاء الاشتراك في البريد التسويقي: <a href="/abonelik-iptal.html">تفضيلات البريد</a>.',
  trialTitle: 'وصول مبكر Pro',
  trialDesc: 'ميزات Pro في مرحلة وصول تجريبي. سيتم إعلامك بعد تفعيل مزود الدفع.',
  proPriceHint: 'وصول تجريبي · إشعار بعد التفعيل',
  ...
  trustTrial: 'وصول تجريبي Pro',
  trustPayment: 'بعد تفعيل الدفع',
  trustCancel: 'إلغاء عبر الدعم',
