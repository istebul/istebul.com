...
const tr = {
  ...
  paymentDesc:
    'Ödeme iyzico (birincil) ve PayTR (yedek) altyapısı ile alınır; kart bilgileri sunucularımızda tutulmaz.',
  cancelTitle: 'İptal',
  cancelDescHtml:
    'Aboneliğinizi hesabınızdan veya destek kanalından istediğiniz zaman sonlandırabilirsiniz. <a href="/abonelik-iptal.html">İptal rehberi</a>',
  trialTitle: 'Pro aktivasyonu',
  trialDesc:
    'Ödeme sağlayıcısı yapılandırıldığında Pro aboneliği veya tek seferlik premium rapor satın alımı bu kanallar üzerinden tamamlanır.',
  ...
  freeCta: 'Ücretsiz karar analizi başlat',
  proName: 'isteBul Pro',
  proDesc: 'Detaylı TCO, senaryo karşılaştırma, gelişmiş AI açıklama ve premium rapor',
  proSecondaryCta: 'Önce ücretsiz karar analizi',
  proPriceHint: 'iyzico / PayTR · dilediğiniz zaman iptal',
  trialHint: ' · Türkiye ödeme altyapısı',
  ...
  trustTrial: 'Türkiye ödeme altyapısı (iyzico / PayTR)',
  trustPayment: 'iyzico / PayTR ile güvenli ödeme',
