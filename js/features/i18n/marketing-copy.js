...
const baseMarketingCopy = {
  tr: {
    nav: {
      ...
      decisionCategoriesMenu: 'Karar Kategorileri menüsü',
  ...
  en: {
    nav: {
      ...
      decisionCategories: 'Decision categories',
      decisionCategoriesMenu: 'Decision categories menu',
      productAi: 'İSTEBUL AI',
      productGarson: 'GarsonAI',
      productBusiness: 'İSTEBUL Business',
  ...
  de: {
    nav: {
      ...
      decisionCategories: 'Entscheidungskategorien',
      decisionCategoriesMenu: 'Entscheidungskategorien-Menü',
      productAi: 'İSTEBUL AI',
      productGarson: 'GarsonAI',
      productBusiness: 'İSTEBUL Business',
  ...
  ar: {
    nav: {
      ...
      decisionCategories: 'فئات القرار',
      decisionCategoriesMenu: 'قائمة فئات القرار',
      productAi: 'İSTEBUL AI',
      productGarson: 'GarsonAI',
      productBusiness: 'İSTEBUL Business',
