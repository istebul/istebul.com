/**
 * Executive Decision Report v1 — client entry (Sprint-26).
 */
...
export { buildExecutiveReportPanelHtml, buildExecutiveReportShellHtml } from './executive-report-card-builder.js';
