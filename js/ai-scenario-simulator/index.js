/**
 * Scenario Simulator v1 — client entry (Sprint-28).
 */
...
export { buildScenarioPanelHtml, buildScenarioTeaserHtml, buildScenarioShellHtml } from './scenario-card-builder.js';
