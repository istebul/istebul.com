...
export function buildCycleCountEvaluationPayload(
  input
) {
...
export async function evaluateCycleCountFirstCount({
  accessToken,
  accountId,
  warehouseId,
  cycleCountId,
  ...
  if (
    ...
    if (
      ...
      throw new Error(
        responseMessage(
          body,
          "Değerlendirilecek sayım görevi artık bulunamıyor."
        )
      );
    }
    ...
    if (
      ...
      throw new Error(
        responseMessage(
          body,
          "Sayım değerlendirmesi başka bir işlemle çakıştı."
        )
      );
    }
    ...
    if (
      ...
      throw new Error(
        responseMessage(
          body,
          "Sayım değerlendirmesi için mevcut görev durumu uygun değil."
        )
      );
    }
