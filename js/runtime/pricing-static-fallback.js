          ...
          <div class="revenue-pricing-grid revenue-pricing-grid--triple revenue-pricing-grid--cards">
            <article class="revenue-plan-card">
              ...
              <ul class="revenue-plan-features">
                <li class="revenue-plan-feature"><span class="revenue-plan-feature-icon" aria-hidden="true">✓</span><span>5 adımlı maliyet analizi</span></li>
                <li class="revenue-plan-feature"><span class="revenue-plan-feature-icon" aria-hidden="true">✓</span><span>2 araç TCO karşılaştırma</span></li>
                <li class="revenue-plan-feature"><span class="revenue-plan-feature-icon" aria-hidden="true">✓</span><span>Şeffaf metodoloji özeti</span></li>
              </ul>
              <div class="revenue-plan-card-foot">
                <a href="/auto/" class="btn btn-outline btn-block" data-analytics-cta="cta_primary_auto" data-analytics-placement="pricing_static_free">Ücretsiz maliyet analizi</a>
              </div>
            </article>
            <article class="revenue-plan-card revenue-plan-card--featured">
              ...
              <ul class="revenue-plan-features">
                ...
                <li class="revenue-plan-feature"><span class="revenue-plan-feature-icon" aria-hidden="true">✓</span><span>Detaylı premium karar raporu</span></li>
              ...
              <div class="revenue-plan-card-foot">
                <a href="/planlar?checkout=pro" class="btn btn-primary btn-block" data-native-route data-analytics-cta="cta_primary_checkout" data-analytics-placement="pricing_static_pro">Karar netliği için dene</a>
