-- WarehouseIQ — Recount Evaluation request_payload düzeltmesi
--
-- warehouse_cycle_count_write_requests gerçek kolon sözleşmesi
-- request_payload kullanır.
--
-- Inventory mutation yok.
-- Adjustment/approval mutation yok.
-- Recount lifecycle davranışı değişmez.
